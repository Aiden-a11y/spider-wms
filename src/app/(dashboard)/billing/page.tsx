                          ...
                          <table className="w-full text-xs min-w-max">
                            <thead className="bg-slate-50 sticky top-0 z-10">
                              <tr>
                                ...
                                <th className="px-3 py-2 text-left text-slate-500 font-semibold">Order No</th>
                              ...
                              const i = (sourcePage - 1) * SOURCE_PAGE_SIZE + _pi;
                                ...
                                return (
                                  <tr key={i} className={`border-b border-slate-50 ${missingDate ? "bg-yellow-50" : isContainer ? "bg-slate-50/60" : "hover:bg-slate-50"}`}>
                                    ...
                                    <td className="px-3 py-1 text-slate-400 font-mono text-[10px] whitespace-nowrap">{String(o.inboundOrderNo ?? o.receiveOrderNo ?? o.orderNo ?? "—")}</td>
